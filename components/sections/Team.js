...
export default function Team() {
  return (
    <div className="bg-[#000719] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-400">
            Multi-skilled team that knows how to deliver complex platforms
          </p>
        </div>
        <ul
          role="list"
          ...
          {people.map((person) => (
            <li key={person.name} className="rounded-2xl px-8 py-10">
              <Image
                ...
                height={200}
                loading="lazy"
                className="mx-auto h-48 w-48 rounded-full md:h-56 md:w-56 grayscale"
                src={person.imageUrl}
                alt=""
              />
