...
export default function Footer() {
  ...
  return (
    <footer
      className={`bg-[#000414]   ${path === "/app" && "hidden"}`}
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="flex flex-col lg:flex-row items-top justify-between">
          ...
          <div className="mt-16 grid grid-cols-1 gap-10  xl:mt-0">
            <div className="md:grid md:grid-cols-3 md:gap-x-24">
              <div>
                <h3 className="text-sm font-semibold leading-3 text-gray-500">
                  Equalizer Price
                </h3>
                <p className="mt-6 space-y-4 text-sm leading-3 tex-white hover:text-white">
                  (DFL) $0.04
                </p>
              </div>
              <div>
